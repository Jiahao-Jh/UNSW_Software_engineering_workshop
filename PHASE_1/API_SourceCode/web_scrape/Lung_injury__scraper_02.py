...
def scraper(url, date, access_time):
    ...
    # store main_text                   
    part_01 = " ".join(soup.find("div", class_="col-md-8 splash-col").text.split())

    part_02 = " ".join(soup.find("div", class_="card bt-3 bt-amber-s mb-3").text.split())

    part_03 = " ".join(soup.find("div", class_="card-body bg-white").text.split())
    main_text = part_01 + "\n" + part_02 + "\n" + part_03 
